...
const long scrollDelay = 79;   // adjust scrolling speed
unsigned long bufferLong [14] = {0};  
LedControl lc=LedControl(5,6,7,numDevices);//DATA | CLK | CS/LOAD | number of matrices
const unsigned char scrollText[] PROGMEM ={" HAPPY NEW YEAR.....happy new year  "};
